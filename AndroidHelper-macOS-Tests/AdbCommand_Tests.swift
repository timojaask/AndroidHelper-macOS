...
class AdbCommand_Tests: XCTestCase {
    func testStart1() {
        XCTAssertEqual(AdbCommand.start(
            ...
            activity: "com.company.StartActivity1").toString(),
    ...
    func testStart2() {
        XCTAssertEqual(AdbCommand.start(
            ...
            activity: "com.company.StartActivity2").toString(),
